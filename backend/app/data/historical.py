...
from app.data.team_mapping import DATASET_TO_WC
...
def preprocess_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df["home_team"] = df["home_team"].map(lambda n: DATASET_TO_WC.get(n, n))
    df["away_team"] = df["away_team"].map(lambda n: DATASET_TO_WC.get(n, n))
